...
all_characters = [*USERS, HIGH_SPARROW, NO_ONE]             # Fixme: this list should contain all characters together.
...
cities = {item.get('From') for item in all_characters if item.get('From') is not None}   # Fixme: this collection should contain only unique cities.
